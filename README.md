...
# 📖 [Library Management Solution] <a name="about-project"></a>

> **[School Library]** is a database driven console application

## 🛠 Designed In <a name="built-with">Ruby with PostgreSQL as the database server</a>
...
- **[Presents a list of actions user can take]**
- 1 list all books
- 2 list all people
- 3 create a person
- 4 create a book
...
User select a number corresponding to the action he/she wants to take and follows the prompt
